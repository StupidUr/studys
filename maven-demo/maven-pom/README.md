...
全球唯一 所以package 害怕重复 所以也用 域名反转
版本号：
    内部版本号： 数字 10000都可以 给机器看 （用于系统更新，客户端更新）
    外部版本号： 字符串 v1.0.0 语义化 1 架构 0 功能 0 BUG（按下葫芦起了瓢）
...
> mvn help:effective-pom --实际生效的pom
